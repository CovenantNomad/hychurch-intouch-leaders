          ...
          <li key={step.id} className={'relative flex flex-1'}>
            {step.id < stepIdx ? (
              <div className="group w-full flex items-center">
                <span className="w-full flex flex-col items-center px-6 py-2 gap-y-1 text-sm font-medium md:flex-row md:gap-y-0">
                  <span className="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-full bg-teal-500 group-hover:bg-teal-700">
                    <BsCheckLg width={20} height={20} color={'#fff'} />
                  </span>
              ...
              <div
                className="group w-full flex flex-col items-center justify-center gap-y-1 -ml-2 px-6 py-2 text-sm font-medium md:flex-row md:gap-y-0 md:-ml-0 md:justify-start"
                aria-current="step"
              >
                <span className="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-full border-2 border-teal-600">
                  <span className="text-teal-600">{step.id + 1}</span>
                </span>
                <span className="text-teal-500 md:ml-4">{step.title}</span>
              </div>
            ) : (
              <div className="group w-full flex items-center justify-center gap-y-1 -ml-2 text-sm font-medium md:flex-row md:justify-start md:gap-y-0 md:-ml-0 ">
                <span className="flex flex-col items-center px-6 py-2 gap-y-1 text-sm font-medium md:flex-row md:gap-y-0">
